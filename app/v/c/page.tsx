...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#CBC4B4]">
      {/* ============ HEADER ============ */}
      <header className="border-b border-[#06634D]/20 bg-[#CBC4B4]">
      ...
      {/* ============ STICKY SEARCH BAR ============ */}
      <div className="sticky top-0 z-20 bg-[#CBC4B4]/95 backdrop-blur-sm border-b border-gray-200/50">
